...
class BackendJobPostingForm extends StatefulWidget {
  @override
  _BackendJobPostingFormState createState() => _BackendJobPostingFormState();
}

class _BackendJobPostingFormState extends State<BackendJobPostingForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Job Posting Form - Backend Development',
